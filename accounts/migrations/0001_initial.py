    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text=b'Other Ithacash users can use this username to pay you.', unique=True, max_length=120)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(default=b'Ithaca', max_length=255)),
                ('state', models.CharField(default=b'NY', max_length=255)),
                ('zip_code', models.CharField(default=b'14850', max_length=255)),
